...
#endif
{
    ...
    // --- SHARP SPLATMAP BLENDING ---
    half maxVal = max(max(splatControl.r, splatControl.g),
        max(splatControl.b, splatControl.a));
    half threshold = 0.01;
    splatControl.r = splatControl.r >= maxVal - threshold ? 1.0h : 0.0h;
    splatControl.g = splatControl.g >= maxVal - threshold ? 1.0h : 0.0h;
    splatControl.b = splatControl.b >= maxVal - threshold ? 1.0h : 0.0h;
    splatControl.a = splatControl.a >= maxVal - threshold ? 1.0h : 0.0h;
    // --- END SHARP BLENDING ---
